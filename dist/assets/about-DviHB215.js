import{g as s,r as d,a as c,s as u,b as i}from"./utils-C1HqCLCR.js";import{S as o}from"./ScrollTrigger-DNECHiyU.js";s.registerPlugin(o);window.addEventListener("load",()=>{const e=document.getElementById("loader");s.to(e,{opacity:0,duration:.8,delay:.3,ease:"power2.out",onComplete:()=>e.classList.add("hidden")})});function m(){const e=document.getElementById("about-bio-1"),t=document.getElementById("about-bio-2"),a=document.getElementById("about-bio-3");e&&(e.textContent=i.about.bio1),t&&(t.textContent=i.about.bio2),a&&(a.textContent=i.about.bio3)}function p(){const e=document.getElementById("achievement-grid");e&&(e.innerHTML=i.about.achievements.map((t,a)=>`
    ...
    `).join(""),l(e))}function l(e){e.querySelectorAll(".reveal-up").forEach(t=>{const a=parseFloat(t.dataset.delay)||0;o.create({trigger:t,start:"top 85%",once:!0,onEnter:()=>{s.to(t,{opacity:1,y:0,duration:.7,delay:a,ease:"power3.out",overwrite:"auto"})}})})}function f(){m(),p(),v(),b(),h(),d("-about"),c("footer-text-about"),u();const e=document.querySelector(".footer-top");e&&e.addEventListener("click",t=>{t.preventDefault(),window.scrollTo({top:0,behavior:"smooth"})}),o.refresh()}document.addEventListener("DOMContentLoaded",f);
